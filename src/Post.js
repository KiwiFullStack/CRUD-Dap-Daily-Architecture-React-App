...
class Post extends Component {
  ...
  render() {
    var { id, name, description, location, photo } = this.props;
    return (
      <div className="post-group">
        ...
        <div className="commentsbox">
          <div className="comment comment1">
            <img
              alt="DAP"
              src="https://img.rawpixel.com/s3fs-private/rawpixel_images/website_content/277-pom-009777-chim.jpg?w=1000&dpr=1&fit=default&crop=default&q=65&vib=3&con=3&usm=15&bg=F4F4F3&ixlib=js-2.2.1&s=83bc3f756995eab9c6176211c3fbee62"
            />
